...
export const GARMENT_FIELDS: Record<GarmentType, FieldConfig[]> = {
  blouse: [
    // User preferred order: Apex Point, Length, Half Body, Shoulder, Bust, Waist, Hip, Sleeve Length, Sleeve Round, Neck Depth Front, Neck Depth Back, others
  ...
  lehenga: [
    // Priority order: Length first, then key measurements
